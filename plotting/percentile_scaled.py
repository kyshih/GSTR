...
def plot_scaled_percentile_comparisons(input_df,input_df1=None,input_df2=None,title1='',title2='',title3='',
    ...
    trait_of_interest = 'LN_mean_relative_scaled'
    ...
    temp_q_list0 = [str(x) + '_percentile_relative_scaled' for x in input_percentile]
...
def melt_dataframe(df, percentile_labels):
    ...
    temp_q_list0 = [f"{x}_percentile_relative_scaled" for x in percentile_labels]
