...
def GD_S(treated_df, untreated_df, input_control_gRNA_list, base_cutoff, percentiles, group_col,
                       learning_rate=0.001, max_iter=10000, tolerance=40000, epsilon=0.5, loss="L1"):
    S = 1
...
# def minimize_ks_loss_S(treated_df, untreated_df, input_control_gRNA_list, base_cutoff_tr):
#     initial_S = 1
#     result = minimize(ks_loss, initial_S, args=(treated_df, untreated_df, input_control_gRNA_list, ))
    
def find_S(treated_df, untreated_df, gRNAs, base_cutoff, percentiles=[50, 70, 80, 90], group_col=None,
           method='minimize_scalar', loss="ks"):
    """
